...
urlpatterns = [
    ...
    path('api/tasks/<int:pk>/update/', EditTaskView.as_view(), name='update-task'),
    path('api/tasks/<int:pk>/delete/', DeleteTaskView.as_view(), name='update-task'),
    ...
    path('tasks/search/', UserTaskSearchView.as_view(), name='task-search'),
    path('api/admin/pending-in-review-tasks/', AdminPendingInReviewTasksView.as_view(), name='admin_pending_in_review_tasks'),
